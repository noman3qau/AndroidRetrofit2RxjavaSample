package noman.com.retrofit2rxjava;
...
import noman.com.retrofit2rxjava.retrofit.RetrofitApis;
...
public class TwitterActivity extends AppCompatActivity {
    ...
    private String credentials = Credentials.basic("Kjg1WVXiEe9gHP6gKn9XILC12", "eYHGWzOxwtQePK1WFCtOdzBXRzH1TQAqlFgkjNfBp7Hqb7pDZH");
    ...
    private void createTwitterApi() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(RetrofitApis.BASE_URL_TWITTER)
                .client(okHttpClient)
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.request_token_button:
                retrofitApis.postCredentials("client_credentials").enqueue(tokenCallback);
                break;
            case R.id.request_user_details_button:
                String editTextInput = usernameEditText.getText().toString();
                if (!editTextInput.isEmpty()) {
                    retrofitApis.getUserDetails(editTextInput).enqueue(userDetailsCallback);
                } else {
    ...
    Callback<OAuthToken> tokenCallback = new Callback<OAuthToken>() {
        ...
        public void onResponse(Call<OAuthToken> call, Response<OAuthToken> response) {
            if (response.isSuccessful()) {
                ...
                Toast.makeText(TwitterActivity.this, "Failure while requesting token", Toast.LENGTH_LONG).show();
    ...
    Callback<UserDetails> userDetailsCallback = new Callback<UserDetails>() {
        ...
        public void onResponse(Call<UserDetails> call, Response<UserDetails> response) {
            if (response.isSuccessful()) {
                ...
                Toast.makeText(TwitterActivity.this, "Failure while requesting user details", Toast.LENGTH_LONG).show();
